...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2025 a las 00:30:22
...
('360-8960 Filtro De Combustible Para Motores Cat', 'Los filtros de combustible de eficiencia avanzada Cat 360-8960 están diseñados para eliminar las partículas contaminantes pequeñas que causan el mayor daño. Con todos los filtros de combustible, se pueden eliminar algunas partículas, pero varios filtros de la competencia no son eficaces a la hora de capturar o retener las partículas que causan el mayor daño a los componentes sensibles de los sistemas de combustible.', 11, 1),
